...
import classNames from "./DialogContentContainer.module.scss";
import DialogContentContainerProps from "./DialogContentContainerProps";

export default function DialogContentContainer(
  props: DialogContentContainerProps
): React.ReactElement {
