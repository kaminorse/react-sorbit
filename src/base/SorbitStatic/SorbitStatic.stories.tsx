...
import SorbitStatic from "./SorbitStatic";
import {
  Button,
  Div,
  Message,
...
const meta = {
  title: "Base/SorbitStatic",
  component: SorbitStatic,
  tags: ["autodocs"],
  argTypes: {},
} satisfies Meta<typeof SorbitStatic>;
...
export const LightTheme: Story = {
  ...
  render: (props) => <SorbitStatic {...props}>{elem}</SorbitStatic>,
};
