    ...
    if (cssVariableSetting.typography) {
      ...
      if (typography.fontSize) {
        ...
        if (typography.fontSize.normal) {
          rootStyles.push(`--font-size-normal: ${typography.fontSize.normal};`);
        }
        if (typography.fontSize.medium) {
          rootStyles.push(`--font-size-medium: ${typography.fontSize.medium};`);
        }
      ...
      if (typography.fontWeight) {
        ...
        if (typography.fontWeight.bold) {
          rootStyles.push(`--font-weight-bold: ${typography.fontWeight.bold};`);
        }
      }
    }
  }
